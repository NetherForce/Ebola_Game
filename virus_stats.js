...
class Virus {
    ...
    updatePerDay(){
        for(let i = 0; i < this.infectedIn.length; i++) {
            // Infect people based on virus' infectivity
            if (Math.random() < (this.infectivity + this.bonus.infectivity) / 100) {
            ...
            // Kill people based on virus' lethality
            if (Math.random() < (this.lethality + this.bonus.lethality) / 100) {
